...
### Structural
24. `[High]` ✅ `rem` conversion + semantic-token consolidation both done (615 of 690 CSS declarations now on the 9 role tokens) - see §7 addendum below. Inline `fontSize` (the 923 sites from the `rem` pass) not yet consolidated onto role tokens, same reasoning applies if picked up later.
