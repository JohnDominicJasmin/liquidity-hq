...
export interface LandingDict {
  ...
  pricing: {
    label: string;
    h2: string;
    free: { name: string; sub: string; features: Array<{ text: string; included: boolean }>; cta: string };
...
export const en: LandingDict = {
  ...
  features: {
    ...
    cards: [
      ...
      { title: 'Squeeze Scanner', desc: '3-signal squeeze score across all 50 markets simultaneously. Funding rate + L/S ratio + taker pressure - when all three align, it flags a high-conviction squeeze setup.', pills: ['Score 0–100', 'All coins', '4h cooldown'] },
    ],
  },
  howItWorks: {
    label: 'How it works',
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        { text: 'Dashboard + market overview', included: true },
        { text: 'Morning briefing', included: true },
        { text: 'News feed', included: true },
        { text: 'All 50 markets - squeeze scanner', included: true },
    ...
    pro: {
      ...
      features: ['Everything in Free', 'Signals on 1m/5m/15m charts', 'Confluence Score, Order Flow, and Absorption Detector', 'On-chain and macro AI analysis', 'Telegram alerts - all signal types', 'Unlimited price alerts', '30 Quick + 10 Deep analyses / day', '50 AI chat messages / day', '10 live searches / day', '25 AI tool runs / day (shared)', 'Priority support'],
      cta: 'Get Pro - $35/mo',
    },
  },
...
export const ko: LandingDict = {
  ...
  features: {
    ...
    sub: '신호, 알림, 분석까지 - 각 도구는 하나의 질문에 답하도록 만들어졌습니다.',
    openLabel: '열기',
    cards: [
...
export const ar: LandingDict = {
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        { text: 'لوحة التحكم + نظرة عامة على السوق', included: true },
        { text: 'الموجز الصباحي', included: true },
    ...
    pro: {
      ...
      features: ['كل ما في الخطة المجانية', 'إشارات على الرسوم البيانية لدقيقة و5 دقائق و15 دقيقة', 'درجة التقاطع، تدفق الأوامر، وكاشف الامتصاص', 'تحليل ذكاء اصطناعي للبيانات على السلسلة والاقتصاد الكلي العالمي', 'تنبيهات تيليجرام - جميع أنواع الإشارات', 'تنبيهات أسعار غير محدودة', '30 تحليلًا سريعًا + 10 تحليلات معمّقة يوميًا', '50 رسالة دردشة ذكاء اصطناعي يوميًا', '10 عمليات بحث مباشر يوميًا', '25 تشغيلًا لأدوات الذكاء الاصطناعي يوميًا (رصيد مشترك)', 'دعم ذو أولوية'],
