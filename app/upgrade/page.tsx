  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--txt)', fontFamily: 'inherit' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'var(--bg)', borderBottom: '0.5px solid var(--bdr)', padding: '0 24px', height: 52, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Link href="/arena" style={{ fontSize: '0.8125rem', color: 'var(--txt3)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
          ← Back
        </Link>
        <span style={{ fontSize: '0.875rem', fontWeight: 800, letterSpacing: '-.02em', color: 'var(--txt)' }}>
          LiquidityHQ
        </span>
        <div style={{ width: 48 }} />
      </nav>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--accent)', background: 'var(--accent-bg)', border: '0.5px solid var(--accent-bdr)', borderRadius: 20, padding: '4px 14px', marginBottom: 20 }}>
            Pro Plan
          </div>
          ...
          <p style={{ fontSize: '1rem', color: 'var(--txt2)', margin: 0, lineHeight: 1.65, maxWidth: 440, marginInline: 'auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, marginBottom: 36 }}>
          ...
          <div style={{ borderRadius: 16, padding: '24px 28px', border: '0.5px solid var(--bdr)', background: 'var(--bg1)' }}>
            <div style={{ fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--txt3)', marginBottom: 6 }}>Current plan</div>
            <div style={{ fontSize: '0.8125rem', fontWeight: 800, color: 'var(--txt)', marginBottom: 2 }}>Free</div>
            <div style={{ fontSize: '2rem', fontWeight: 900, letterSpacing: '-.04em', marginBottom: 20 }}>$0<span style={{ fontSize: '0.875rem', fontWeight: 400, color: 'var(--txt3)' }}>/mo</span></div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 9 }}>
              {FREE_FEATURES.map(f => (
                <li key={f} style={{ fontSize: '0.8125rem', color: 'var(--txt2)', display: 'flex', alignItems: 'flex-start', gap: 8 }}>
          ...
          <div style={{ borderRadius: 16, padding: '24px 28px', border: '0.5px solid var(--accent-bdr)', background: 'linear-gradient(160deg, var(--accent-bg) 0%, var(--bg1) 60%)', position: 'relative' }}>
            <div style={{ position: 'absolute', top: -11, left: '50%', transform: 'translateX(-50%)', fontSize: '0.625rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', background: 'var(--accent)', color: '#fff', padding: '3px 14px', borderRadius: 20, whiteSpace: 'nowrap' }}>
              Recommended
            </div>
            <div style={{ fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--accent)', marginBottom: 6 }}>Upgrade to</div>
            <div style={{ fontSize: '0.8125rem', fontWeight: 800, color: 'var(--txt)', marginBottom: 2 }}>Pro</div>
            <div style={{ fontSize: '2rem', fontWeight: 900, letterSpacing: '-.04em', marginBottom: 20 }}>$15<span style={{ fontSize: '0.875rem', fontWeight: 400, color: 'var(--txt3)' }}>/mo</span></div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 9 }}>
              {PRO_FEATURES.map(f => (
                <li key={f} style={{ fontSize: '0.8125rem', color: 'var(--txt2)', display: 'flex', alignItems: 'flex-start', gap: 8 }}>
          ...
          {CHECKOUT_CONFIGURED ? (
            <>
              <button
                ...
                style={{ fontSize: '0.9375rem', fontWeight: 700, color: '#fff', background: 'var(--accent)', padding: '14px 40px', borderRadius: 12, border: 'none', cursor: redirecting ? 'default' : 'pointer', opacity: redirecting ? 0.7 : 1, transition: 'opacity .15s, transform .15s', transform: 'translateY(0)' }}
              ...
              <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', justifyContent: 'center' }}>
                {['Cancel anytime', 'Instant access', 'Secure checkout'].map(t => (
                  <span key={t} style={{ fontSize: '0.75rem', color: 'var(--txt3)', display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <div style={{ borderRadius: 14, padding: '28px 36px', border: '0.5px solid var(--accent-bdr)', background: 'var(--accent-bg)', maxWidth: 400, width: '100%' }}>
              ...
              <div style={{ fontSize: '0.9375rem', fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
                Pro payments launching soon
              </div>
              <p style={{ fontSize: '0.8125rem', color: 'var(--txt2)', lineHeight: 1.65, margin: '0 0 16px' }}>
              ...
              <Link href="/arena" style={{ fontSize: '0.8125rem', color: 'var(--txt3)', textDecoration: 'underline' }}>
                Back to Arena
              </Link>
            </div>
          )}
