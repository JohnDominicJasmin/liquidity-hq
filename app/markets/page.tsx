      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 12px 80px' }}>
        ...
        <div style={{
          ...
          <button
            onClick={() => router.back()}
            style={{
              fontSize: '0.6875rem', color: 'var(--txt3)', padding: '4px 10px',
          ...
          <div>
            <div style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--txt)', letterSpacing: '.04em', textTransform: 'uppercase' }}>
              Markets
            </div>
          ...
          <div className="mkt-mono" style={{ marginLeft: 'auto', display: 'flex', gap: 14, fontSize: '0.625rem' }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 10, flexWrap: 'wrap' }}>
          <input
            ...
            style={{
              ...
              fontSize: '0.75rem', color: 'var(--txt)', outline: 'none',
            }}
          />
        ...
        <div className="mkt-mono mkt-hdr-row" style={{
          ...
          padding: '0 10px 6px',
          fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '.1em',
          ...
          return (
            ...
            >
              ...
              <div style={{ paddingLeft: 10, display: 'flex', alignItems: 'center', gap: 7, minWidth: 0 }}>
                ...
                <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--txt)', letterSpacing: '.02em' }}>
                  {id.toUpperCase()}
                </span>
              </div>
              ...
              {/* Price */}
              <div className="mkt-mono" style={{ textAlign: 'right', fontSize: '0.75rem', fontWeight: 600, color: 'var(--txt2)' }}>
                {d?.price ? '$' + fmtPrice(d.price, dec) : '-'}
              </div>

              {/* Change */}
              <div className="mkt-mono" style={{
                textAlign: 'right', fontSize: '0.6875rem', fontWeight: 700,
              ...
              <div className="mkt-col-pressure" style={{ paddingLeft: 4, paddingRight: 8 }}>
                ...
                <div className="mkt-mono" style={{ fontSize: '0.6875rem', color: 'var(--txt3)', marginTop: 2 }}>
                  {tbp}% buy
                </div>
              </div>
              ...
              <div className="mkt-signal" style={{
                paddingLeft: 12, fontSize: '0.625rem',
        ...
        {rows.length === 0 && (
          <div style={{ padding: '32px 10px', textAlign: 'center', fontSize: '0.75rem', color: 'var(--txt3)' }}>
        ...
        {rows.length > 0 && (
          <div style={{
            ...
            <span className="mkt-mono" style={{ fontSize: '0.625rem', color: 'var(--txt3)' }}>
