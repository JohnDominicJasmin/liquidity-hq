...
export default function NotFound() {
  return (
    <div style={{
      ...
      <div style={{
        fontSize: '1.75rem', fontWeight: 800, color: 'var(--txt1, #e8e8e8)',
        fontFamily: "'JetBrains Mono', monospace",
      }}>
        404 - Liquidity not found
      </div>
      <div style={{ fontSize: '0.8125rem', color: 'var(--txt3, #808080)', maxWidth: 420, lineHeight: 1.6 }}>
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
        <Link href="/" style={{
          padding: '9px 18px', borderRadius: 10, fontSize: '0.8125rem', fontWeight: 700,
