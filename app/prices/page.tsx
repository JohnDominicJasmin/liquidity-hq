    ...
    <div style={{ maxWidth: 700, margin: '0 auto', paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        <Link href="/dashboard" style={{
          ...
          fontSize: 'var(--fs-caption)', color: 'var(--txt3)', textDecoration: 'none',
        ...
        <span style={{
          fontSize: 'var(--fs-micro)', fontWeight: 800, padding: '3px 8px', borderRadius: 20,
          ...
          >
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                <span style={{ fontSize: 'var(--fs-label)', fontWeight: 700, color: 'var(--txt)', letterSpacing: '.03em' }}>
                  {id.toUpperCase()}
                </span>
                {frPct != null && (
                  <span style={{ fontSize: 'var(--fs-caption)', fontWeight: 700, color: frColor, letterSpacing: '.01em' }}>
            ...
            {/* Price */}
            <span style={{
              fontSize: 'var(--fs-data)', fontWeight: 600, color: 'var(--txt)',
