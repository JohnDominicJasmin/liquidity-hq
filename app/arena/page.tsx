      ...
      <>
        <ArenaTerminal
          ...
          /* NOT the reverted wiring, and this is a deliberate departure from
             ...
             **This is an open decision, not a fix (#853/D6, still unresolved
             as of 2026-09-07 - a strike-the-criterion attempt landed on #916
             and was reverted with everything else; do not reapply it here,
             the decision itself is void again, not just the component).**
             specs/arena.md was written while Coinglass worked. What replaced
             the heatmap is LiqFeed - REALIZED liquidations from Binance and
             Bybit, keyless and not BTC-only - which is a different claim from
             PREDICTED levels, not a drop-in. Whether criterion 3's heatmap
             panel becomes a realized-liquidation view, or is struck, is
             design's call, tracked separately on WORK-QUEUE.md row D6. */
          heatmap={null}
