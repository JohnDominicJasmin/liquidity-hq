...
**Current total: 1746 label rows**, identical in both `lhq_labels` (prod) and `lhq_dev_labels` (dev). 67 files fully migrated: 27 pages (about, alerts, arena, backtest, briefing, calc, correlation, dashboard, disclaimer, econ-calendar, funding, hours, journal, liq, live-tracking, login, markets, news, not-found, playbook, prices, privacy, research, scanner, settings, terms, upgrade) + 40 components (AbsorptionDetector, AccumulationTracker, AlertOutcomes, AuthGate, CoinHeatmap, CoinMultiSelect, CycleChart, DcaCalc, DistributionTracker, DrawdownChart, FundingCostCalc, GexTable, GlobalMacroContext, GrokSignalChart, HypothesisTracker, LabelsProvider, LanguageSelect, LanguageSync, LiqHeatmap, LiquidationCalc, MarketConditionsWidget, MarketRead, MarketStructure, MultiTFAlignment, MultiTFSqueezeView, NavDrawer, OnChainScore, PageHint, PnLCalc, PositionSizer, RiskRewardCalc, SettingsModal, SetupScanner, SignalAccuracy, ThemeChips, UpgradeGateModal, UsageMeter, UsageRings, VolatilityRegime, WhaleTradesFeed). Sparkline/Sparkline24h intentionally skipped — pure SVG renderers, zero hardcoded text.
