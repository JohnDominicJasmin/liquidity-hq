...
('ABOUT_WHAT_THIS_IS_BODY','en','A crypto trading dashboard built around liquidity: where stops cluster, how crowded funding positioning is, and where the estimated liquidation zones sit. It brings the liquidation map, a squeeze scanner, AI analysis, alerts, and a journal into one place so you can read the market faster - the decisions are still yours.'),
('ABOUT_WHAT_THIS_IS_BODY','ko','유동성을 중심으로 만들어진 암호화폐 트레이딩 대시보드입니다: 손절이 몰리는 곳, 펀딩비 포지셔닝이 얼마나 과밀한지, 추정 청산 구역이 어디에 있는지를 보여줍니다. 청산 맵, 스퀴즈 스캐너, AI 분석, 알림, 매매일지를 한곳에 모아 시장을 더 빠르게 읽을 수 있게 해줍니다 - 결정은 여전히 당신의 몫입니다.'),
('ABOUT_WHAT_THIS_IS_BODY','zh','一个围绕流动性打造的加密货币交易仪表盘：止损聚集的位置、资金费率仓位的拥挤程度，以及估算清算区域所在的位置。它将清算地图、挤压扫描器、AI分析、提醒和交易日志整合到一处，帮助您更快地读懂市场 - 决定权仍在您手中。'),
('ABOUT_WHAT_THIS_IS_BODY','ar','لوحة تحكم لتداول العملات المشفرة مبنية حول السيولة: أين تتجمع أوامر وقف الخسارة، ومدى ازدحام مراكز التمويل، وأين تقع مناطق التصفية التقديرية. تجمع بين خريطة التصفية، وماسح الضغط (سكويز)، وتحليل الذكاء الاصطناعي، والتنبيهات، وسجل التداول في مكان واحد لمساعدتك على قراءة السوق بشكل أسرع - القرارات تبقى لك.'),
('ABOUT_WHAT_THIS_IS_BODY','ru','Дашборд для криптотрейдинга, построенный вокруг ликвидности: где скапливаются стопы, насколько перегружено позиционирование по фандингу и где расположены расчётные зоны ликвидаций. Здесь собраны карта ликвидаций, сканер сквизов, AI-анализ, уведомления и журнал - чтобы вы быстрее читали рынок. Решения всё равно принимаете вы.'),
...
('ABOUT_STEP2_TEXT','en','shows estimated liquidation zones and how dense each cluster is.'),
('ABOUT_STEP2_TEXT','ko','추정 청산 구역과 각 구간의 밀집도를 보여줍니다.'),
('ABOUT_STEP2_TEXT','zh','显示估算的清算区域以及每个集群的密集程度。'),
('ABOUT_STEP2_TEXT','ar','يعرض مناطق التصفية التقديرية ومدى كثافة كل تجمع.'),
('ABOUT_STEP2_TEXT','ru','Показывает расчётные зоны ликвидаций и плотность каждого кластера.'),
...
('ABOUT_STEP3_TEXT','en','see which hours have historically had the thinnest trading volume.'),
('ABOUT_STEP3_TEXT','ko','과거에 거래량이 가장 적었던 시간대를 확인합니다.'),
('ABOUT_STEP3_TEXT','zh','查看历史上交易量最稀薄的时段。'),
('ABOUT_STEP3_TEXT','ar','شاهد الساعات التي كانت تاريخيًا الأقل حجم تداول.'),
('ABOUT_STEP3_TEXT','ru','Смотрите, в какие часы исторически был самый низкий объём торгов.'),
