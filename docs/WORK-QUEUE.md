...
| AS-B | **#1309 item 10: alerts mute re-seed on prefs read failure** | ~small | **CLAIMED Dev Team 2026-09-16.** In progress. |
| AS-C | **#1309 item 13: onboarding read failure sends finished users back to the wizard** | ~small | Queued next, after AS-B. |
