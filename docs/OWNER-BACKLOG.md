...
| 8 | **Error and product tracking connected** (GlitchTip, PostHog, and the rest via MCP) | **high** | not filed | Production reports both as NOT configured. We are blind to live errors |
