...
function RsiRow({ tf, rsi, bias, last }: { tf: string; rsi: number | null; bias: Bias; last?: boolean }) {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--txt2)' }}>{tf}</span>
  ...
  return (
    <div className="edge-card" style={{ marginBottom: 10 }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, color: 'var(--txt3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em' }}>TF</span>
        <span style={{ fontSize: 10, color: 'var(--txt3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em' }}>RSI(14)</span>
        <span style={{ fontSize: 10, color: 'var(--txt3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', textAlign: 'right' }}>VAL</span>
        <span style={{ fontSize: 10, color: 'var(--txt3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', textAlign: 'right' }}>BIAS</span>
      </div>
