...
function buildSystemCtx(
  ...
  return [
    ...
    'Before calling LONG or SHORT based on an EMA cross, BOTH of these filters must pass:',
    ...
    '2. ATR Buffer: Price must close beyond EMA50 by at least 25% of ATR(14). A marginal 1-tick graze of EMA50 is not a confirmation — it will reverse. Only a meaningful body close clearing the buffer is valid.',
    'If either filter fails → downgrade the signal: LONG → LEAN LONG, SHORT → LEAN SHORT, or FLAT if both fail.',
