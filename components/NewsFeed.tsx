...
export default function NewsFeed() {
  ...
  return (
    <div className="nf-wrap">
      ...
      {filtered.length === 0 ? (
        <div style={{ fontSize: 'var(--fs-caption)', color: '#444', textAlign: 'center', padding: '1.5rem 0' }}>
      ...
      <div style={{ fontSize: 'var(--fs-caption)', color: 'var(--txt3)', marginTop: 10, paddingTop: 8, borderTop: '0.5px solid var(--bdr)' }}>
