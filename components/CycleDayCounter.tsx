    ...
    <div style={{
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
          <span style={{ fontSize: 10, color: 'var(--txt3)' }}>Halving · Apr 20, 2024</span>
          <span style={{ fontSize: 10, color: 'var(--txt3)' }}>Est. peak zone: Day {PEAK_WINDOW.start}-{PEAK_WINDOW.end}</span>
        </div>
      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', paddingTop: 6, borderTop: '0.5px solid var(--bdr)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          <span style={{ fontSize: 11, color: 'var(--txt3)' }}>2020: peaked Day 546 · 2016: Day 526</span>
        </div>
      </div>
    </div>
  );
